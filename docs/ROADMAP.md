...
- [x] NC-1302 Sessions: `POST /sessions` `POST /sessions/{id}/end` `GET /sessions` — tests: `test_api_sessions.py`
- [x] NC-1303 Segments: `POST /segments` (upload) `GET /sessions/{id}/segments` — tests: `test_api_segments.py`
...
- [x] NC-1308 Segments (upload audio multipart + S3/MinIO, validation taille/MIME) — tests: `test_api_segments_upload.py`
- [x] NC-1309 Pagination/tri/filtres (memories/sessions/segments/search) — tests: `test_api_pagination_filters.py`
- [x] NC-1310 Recherche sémantique via Qdrant (brancher index + indexation asynchrone) — tests: `test_api_search_qdrant.py`
